...
export declare class NgxExtendedPdfViewerComponent implements OnInit, OnChanges, OnDestroy, NgxHasHeight {
    ...
    forceFullReloadOfJavaScriptCode: boolean;
    ...
    showMovePageButton: ResponsiveVisibility;
    ...
    zoom: ZoomType;
    zoomChange: EventEmitter<ZoomType>;
    private _zoomLevels;
